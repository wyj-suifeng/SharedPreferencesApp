package com.example.lenovo.sharedpreferencesapp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnWrite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String strLoginDate = simpleDateFormat.format(new java.util.Date());

                //写入键值对
                editor.putString(Key_UserName, "王玉杰");
                editor.putString(Key_LoginDate, strLoginDate);
                editor.putInt(Key_UserType, 2014011213);
        ...
        btnRead.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (strUserName != null && strLoginDate != null)
                    Toast.makeText(MainActivity.this, strUserName + "登录时间:" +"用户名:" +  strLoginDate+"学号:"+nUserType, Toast.LENGTH_LONG).show();
                else
